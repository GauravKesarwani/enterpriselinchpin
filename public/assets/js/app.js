...
//
    ...
    var handlePortletTools = function () {
        jQuery('.portlet .tools a.remove').unbind("click").click(function () {
        ...
        jQuery('.portlet .tools a.reload').unbind("click").click(function () {
        ...
        jQuery('.portlet .tools .collapse, .portlet .tools .expand').unbind("click").click(function () {
